...
public class Notification extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        NotificationObject notificationObject =
                new NotificationObject(text, keyword, channel, from, to, notificationId, userid);
        String strJson = qh.getJsonObject(notificationObject);
        qh.InsertToNotificationQueue(notificationObject);
