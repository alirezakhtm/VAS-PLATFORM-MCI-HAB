...
public class ServiceUsers {
    ...
    public ServiceUsers(int serviceCode, String msisdn, int subStatus, String membershipDate, String unsubDate, int selctedCategoryIndex, String unsubBy, String subBy, String numberType) {
